...
func TestBrowserTraceAnalysisFixtureCorpusMatchesCommittedInventoryByteForByte(t *testing.T) {
	...
	expected := map[string]any{
		...
		"records.json":                   pageDTO[recordDTO]{Source: evidence.SourceTarget, TargetScopeID: scope, Items: []recordDTO{{Sequence: 3, Type: "MODEL_RESPONSE_RECEIVED", FrameID: "frame-1", FrameType: "SKILL", Route: "hello", ThreadName: "worker-1", TimestampMillis: 112, Representation: "logical", IsEnvelope: true}}, HasMore: false},
