...
admission, body-limit, SDK, and runtime-tool layers.

The harness runs the protocol-generic scenarios applicable to PR 16 for both
...
by the SDK and assembled HTTP integration suites without an expected-failure
baseline.
