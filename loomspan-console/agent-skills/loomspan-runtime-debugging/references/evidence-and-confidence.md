...
claim to evidence: target scope, session, trace, frame, record sequence,
failure, attempt/retry sequence, artifact handle, payload reference, or exact
range. Include observation time and latest sequence for live claims.
